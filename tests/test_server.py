...
def test_access_token_authorizer(env_vars, authorizer):
    assert SecretServer(
        ...
        AccessTokenAuthorizer(authorizer.get_access_token(), f"https://{env_vars['tenant']}.secretservercloud.com/"),
...
def test_platform_access_token_authorizer(platform_env_vars, platform_authorizer):
    assert SecretServer(
        ...
        AccessTokenAuthorizer(platform_authorizer.get_access_token(), platform_env_vars["platform_base_url"]),
